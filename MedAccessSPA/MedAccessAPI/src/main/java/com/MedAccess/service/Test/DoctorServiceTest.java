...
@PrepareForTest({DoctorServiceTest.class, DoctorService.class, DoctorDAO.class})
public class DoctorServiceTest {
	...
	@Spy
    private DoctorDAO mockDoctorDAO;
    ...
    public void testGetAllDoctors()
    {
        ...
        Mockito.doReturn(mockDoctorList).when(mockDoctorDAO).getAllDoctors();

        //Method call
        List<Doctor> resultDoctorList = doctorService.getAllDoctors();
	...
	public void testGetDoctorById() {
		...
		//Mockito to mock the control from going to service class
				//Mocking DoctorService object
				//DoctorService mockDoctorService = spy(DoctorService.class);
				Mockito.doReturn(mockDoctor).when(mockDoctorDAO).getDoctorById(Mockito.anyString());

				
				
				//Method call
				Doctor result = doctorService.getDoctorById("2");
    ...
    public void testGetDoctorByMail()
    {
		...
		Mockito.doReturn(mockDoctor).when(mockDoctorDAO).getDoctorByMail(Mockito.anyString());

		
		//Method call
		Doctor result = doctorService.getDoctorByMail("vidhyashree1992@gmail.com");
    ...
    public void testGetDoctorByName()
    {
		...
		mockDoctor2.setDoctor_country("Canada");
		mockDoctor2.setDoctor_email("kr536074@dal.ca");
		mockDoctor2.setDoctor_firstname("VIDHYASHREE");
		mockDoctor2.setDoctor_lastname("BOOPATHY");
		mockDoctor2.setDoctor_password("12345");
		mockDoctor2.setDoctor_phone("9027894476");
		mockDoctor2.setDoctor_state("Nova Scotia");
		mockDoctor2.setDoctor_street("Brunswick Street");
        ...
        //Mocking DoctorService object
        //DoctorService mockDoctorService = spy(DoctorService.class);
        Mockito.doReturn(mockDoctorList).when(mockDoctorDAO).getDoctorByName(Mockito.anyString());

        //Method call
        List<Doctor> resultDoctorList = doctorService.getDoctorByName("VIDHYASHREE");
        //List<Doctor> resultDoctorList = response.getBody();
        //Doctor result1 = resultDoctorList.get(0);
        //Doctor result2 = resultDoctorList.get(1);
        Doctor result1 = resultDoctorList.get(0);
    ...
    public void testAddDoctor()
    {
		...
		//Mocking DoctorService object
		//DoctorService mockDoctorService = spy(DoctorService.class);
		Mockito.doNothing().when(mockDoctorDAO).addDoctor(mockDoctor);
		
		
		//Method call
		Boolean response = doctorService.addDoctor(mockDoctor);
    ...
    public void testUpdateDoctor()
    {
		...
		//Mocking DoctorService object
		//DoctorService mockDoctorService = spy(DoctorService.class);
		Mockito.doNothing().when(mockDoctorDAO).updateDoctor(mockDoctor);
		
		//Method call
		 doctorService.updateDoctor(mockDoctor);
	...
	public void testDeleteDoctor() 
    {
    	...
    	//mocking Doctor response
    			...
    			//Mocking DoctorService object
    			//DoctorService mockDoctorService = spy(DoctorService.class);
    			Mockito.doNothing().when(mockDoctorDAO).deleteDoctor("2");
